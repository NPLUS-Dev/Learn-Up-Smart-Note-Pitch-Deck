...
(function () {
  ...
  var DEFAULT = {
    planets: [
      { id: "shm",     label: "Simple Harmonic Motion",           domain: "physics",   mastery: 84 },
      { id: "cnn",     label: "CNN Backpropagation",              domain: "other",     mastery: 76 },
      { id: "cross",   label: "Vector Cross Product",             domain: "math",      mastery: 72 },
      { id: "rot",     label: "Rotational Dynamics",              domain: "physics",   mastery: 67 },
      { id: "benzene", label: "Benzene Ring Structure",           domain: "chemistry", mastery: 63 },
      { id: "neuron",  label: "Neuron Action Potential",          domain: "biology",   mastery: 60 },
      { id: "im2col",  label: "im2col",                           domain: "other",     mastery: 56 },
      { id: "angmom",  label: "Conservation of Angular Momentum", domain: "physics",   mastery: 52 },
      { id: "matrix",  label: "Matrix Transformation",            domain: "math",      mastery: 49 },
      { id: "fourier", label: "Fourier Series",                   domain: "math",      mastery: 43 },
      { id: "echem",   label: "Electrochemistry",                 domain: "chemistry", mastery: 37 },
      { id: "entropy", label: "Entropy",                          domain: "chemistry", mastery: 31 }
    ],
    links: [
